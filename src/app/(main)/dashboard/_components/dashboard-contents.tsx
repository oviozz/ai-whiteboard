...
const LEARNING_TEMPLATES = [
  // Math
  {
    ...
    description: "Linear equations, quadratics, graphing",
    category: "math",
    problems: ["Solve 2x + 5 = 13", "Factor x² - 5x + 6"],
  },
  {
    ...
    category: "math",
    problems: ["Find d/dx of x³ + 2x", "Chain rule"],
  },
  {
    ...
    category: "math",
    problems: ["∫x² dx", "Integration by parts"],
  },
  {
    id: "trigonometry",
    title: "Trigonometry",
    ...
    category: "math",
    problems: ["Solve sin(x) = 0.5", "Prove identity"],
  },
  {
    id: "statistics",
    title: "Statistics",
    ...
    category: "math",
    problems: ["Calculate mean", "Find probability"],
  },
  {
    id: "linear-algebra",
    ...
    category: "math",
    problems: ["Matrix multiplication", "Find determinant"],
  },
  ...
  // Science
  {
    ...
    description: "Atomic structure and chemical bonds",
    category: "science",
    problems: ["Balance equations", "Lewis structures"],
  },
  {
    ...
    category: "science",
    problems: ["Free body diagrams", "Projectile motion"],
  },
  {
    id: "physics-electricity",
    title: "Electricity & Magnetism",
    description: "Circuits, fields, and waves",
    category: "science",
    problems: ["Ohm's law", "Magnetic flux"],
  },
  {
    id: "biology-cells",
    title: "Cell Biology",
    ...
    category: "science",
    problems: ["Label diagram", "Mitosis stages"],
  },
  {
    ...
    category: "science",
    problems: ["Name compounds", "Reaction mechanisms"],
  },
  ...
  // Languages
  {
    ...
    description: "Common phrases and verb conjugations",
    category: "languages",
    problems: ["Conjugate verbs", "Translate sentences"],
  },
  {
    id: "french-basics",
    title: "French Basics",
    description: "Vocabulary and grammar essentials",
    category: "languages",
    problems: ["Gender agreement", "Common phrases"],
  },
  {
    id: "mandarin-basics",
    title: "Mandarin Basics",
    description: "Characters and pronunciation",
    category: "languages",
    problems: ["Character practice", "Tones"],
  },
  {
    id: "english-grammar",
    ...
    category: "languages",
    problems: ["Identify clauses", "Fix errors"],
  },
  ...
  // Coding
  {
    ...
    category: "coding",
    problems: ["Write a function", "List comprehensions"],
  },
  {
    ...
    category: "coding",
    problems: ["Event handling", "Promises"],
  },
  {
    id: "data-structures",
    ...
    category: "coding",
    problems: ["Implement stack", "Tree traversal"],
  },
  {
    id: "algorithms",
    title: "Algorithms",
    ...
    category: "coding",
    problems: ["Binary search", "Big O analysis"],
  },
  {
    id: "sql-basics",
    title: "SQL Basics",
    ...
    category: "coding",
    problems: ["Write SELECT", "Join tables"],
  },
  ...
  // Writing
  {
    ...
    category: "writing",
    problems: ["Thesis statement", "Topic sentences"],
  },
  {
    id: "creative-writing",
    title: "Creative Writing",
    description: "Story structure and character development",
    category: "writing",
    problems: ["Write dialogue", "Plot outline"],
  },
  {
    id: "research-papers",
    title: "Research Papers",
    description: "Citations, methodology, and analysis",
    category: "writing",
    problems: ["MLA format", "Literature review"],
  },
];
...
function WhiteboardDocumentIndicator({
  whiteboardID,
}: {
  ...
  return (
    ...
    >
      ...
      <div className="p-4 pt-5">
        <h3 className="font-semibold text-slate-800 text-base line-clamp-1 pr-16">
          {board.topic}
        </h3>
          ...
          {isLoading ? (
            ...
            <div className="border border-dashed border-slate-200 rounded-xl p-10 text-center">
              ...
              <p className="text-sm text-slate-400 mb-4">
                Create one or pick a template below
              </p>
              <CreateNewWhiteboardButton query={query} />
            </div>
          )}
