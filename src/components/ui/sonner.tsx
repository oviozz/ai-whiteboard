  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "bg-background text-foreground border-border border-2 font-medium rounded-base text-[15px] flex items-center gap-2.5 p-4 w-[356px] [&:has(button)]:justify-between",
